...
export class UserControllerApi {
     ...
     */
    public userControllerCreate(userExcludingIdUsernameIsVirtualRoles?: models.UserExcludingIdUsernameIsVirtualRoles, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.User;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/user/register';
        ...
        requestOptions.data = JSON.stringify(userExcludingIdUsernameIsVirtualRoles);
     ...
     * @param userExcludingIdUsernameIsVirtualRoles 
     */
    public userControllerCreateVirtual(userExcludingIdUsernameIsVirtualRoles?: models.UserExcludingIdUsernameIsVirtualRoles, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.User;  },
    { response: JQueryXHR; errorThrown: string }
    > {
     ...
     */
    public userControllerLogin(userExcludingIdEmailIsVirtualRoles?: models.UserExcludingIdEmailIsVirtualRoles, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    ...
    > {
        ...
        requestOptions.data = JSON.stringify(userExcludingIdEmailIsVirtualRoles);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
