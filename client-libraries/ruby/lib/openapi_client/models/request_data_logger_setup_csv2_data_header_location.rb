  ...
  class RequestDataLoggerSetupCsv2DataHeaderLocation
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::RequestDataLoggerSetupCsv2DataHeaderLocation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::RequestDataLoggerSetupCsv2DataHeaderLocation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'first_item_col')
        self.first_item_col = attributes[:'first_item_col']
      end
    ...
    def list_invalid_properties
      ...
      if @first_item_col.nil?
        invalid_properties.push('invalid value for "first_item_col", first_item_col cannot be nil.')
      end
    ...
    def valid?
      return false if @first_item_col.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          first_item_col == o.first_item_col &&
    ...
    def hash
      [first_item_col, next_item_iteration, model, serial_no, channel_name, channel_unit, period].hash
    end
