...
export class DeviceChannelControllerApi {
     ...
     * @param operation 
     */
    public deviceChannelControllerFindByPeriod(deviceId: number, channelId: number, fromTS: string, toTs: string, page: number, count: number, groupBy: string, operation: string, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: models.ResponseDeviceChannelData;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/device-channel/data-by-period/{deviceId}/{channelId}/from/{fromTS}/to/{toTs}/page/{page}/count/{count}/groupBy/{groupBy}/operation/{operation}'.replace('{' + 'deviceId' + '}', encodeURIComponent(String(deviceId))).replace('{' + 'channelId' + '}', encodeURIComponent(String(channelId))).replace('{' + 'fromTS' + '}', encodeURIComponent(String(fromTS))).replace('{' + 'toTs' + '}', encodeURIComponent(String(toTs))).replace('{' + 'page' + '}', encodeURIComponent(String(page))).replace('{' + 'count' + '}', encodeURIComponent(String(count))).replace('{' + 'groupBy' + '}', encodeURIComponent(String(groupBy))).replace('{' + 'operation' + '}', encodeURIComponent(String(operation)));
