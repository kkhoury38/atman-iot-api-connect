...
export class DeviceControllerApi {
     ...
     * @param all 
     */
    public deviceControllerDisableChannelMonitoring(deviceId: number, channelId: number, all: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/device/{deviceId}/channel/{channelId}/disable-monitoring/all/{all}'.replace('{' + 'deviceId' + '}', encodeURIComponent(String(deviceId))).replace('{' + 'channelId' + '}', encodeURIComponent(String(channelId))).replace('{' + 'all' + '}', encodeURIComponent(String(all)));
     ...
     * @param all 
     */
    public deviceControllerEnableChannelMonitoring(deviceId: number, channelId: number, all: boolean, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/device/{deviceId}/channel/{channelId}/enable-monitoring/all/{all}'.replace('{' + 'deviceId' + '}', encodeURIComponent(String(deviceId))).replace('{' + 'channelId' + '}', encodeURIComponent(String(channelId))).replace('{' + 'all' + '}', encodeURIComponent(String(all)));
     ...
     * @param deviceId 
     */
    public deviceControllerFindChannelTypes(deviceId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
     ...
     * @param modelsDeviceExcludingDescriptionSerialNoDataLoggerIdDeviceTypeId 
     */
    public deviceControllerGetDevicesWithType(modelsDeviceExcludingDescriptionSerialNoDataLoggerIdDeviceTypeId?: Array<models.DeviceExcludingDescriptionSerialNoDataLoggerIdDeviceTypeId>, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: Array<models.DeviceWithType>;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/devices/with-device-type';
        ...
        requestOptions.data = JSON.stringify(modelsDeviceExcludingDescriptionSerialNoDataLoggerIdDeviceTypeId);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
        ...
        >();
        $.ajax(requestOptions).then(
            (data: Array<models.DeviceWithType>, textStatus: string, jqXHR: JQueryXHR) =>
                dfd.resolve({response: jqXHR, body: data}),
            (xhr: JQueryXHR, textStatus: string, errorThrown: string) =>
                dfd.reject({response: xhr, errorThrown: errorThrown})
        );
     ...
     */
    public deviceControllerUpdateById(id: number, deviceExcludingIdSerialNoDataLoggerIdDeviceTypeId?: models.DeviceExcludingIdSerialNoDataLoggerIdDeviceTypeId, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/device/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        requestOptions.data = JSON.stringify(deviceExcludingIdSerialNoDataLoggerIdDeviceTypeId);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
