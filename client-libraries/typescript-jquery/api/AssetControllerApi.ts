...
export class AssetControllerApi {
     ...
     * @param userId 
     */
    public assetControllerFindByUserId(userId: number, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body: Array<models.Asset>;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/assets/by-user/{userId}'.replace('{' + 'userId' + '}', encodeURIComponent(String(userId)));
     ...
     */
    public assetControllerUpdateById(id: number, assetExcludingIdAssetGroupId?: models.AssetExcludingIdAssetGroupId, extraJQueryAjaxSettings?: JQueryAjaxSettings): JQuery.Promise<
    { response: JQueryXHR; body?: any;  },
    { response: JQueryXHR; errorThrown: string }
    > {
        let localVarPath = this.basePath + '/asset/{id}'.replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        ...
        requestOptions.data = JSON.stringify(assetExcludingIdAssetGroupId);
        if (headerParams['Content-Type']) {
            requestOptions.contentType = headerParams['Content-Type'];
        }
