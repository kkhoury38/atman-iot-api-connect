...
export interface AssetGroupControllerUpdateByIdRequest {
    id: number;
    assetGroupExcludingIdUserId?: AssetGroupExcludingIdUserId;
}
...
export class AssetGroupControllerApi extends BaseAPI {
     ...
     */
    assetGroupControllerUpdateById = ({ id, assetGroupExcludingIdUserId }: AssetGroupControllerUpdateByIdRequest): Observable<void> => {
        throwIfNullOrUndefined(id, 'assetGroupControllerUpdateById');
