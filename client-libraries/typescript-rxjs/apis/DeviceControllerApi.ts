...
export interface DeviceControllerGetDevicesWithTypeRequest {
    deviceExcludingDescriptionSerialNoDataLoggerIdDeviceTypeId?: Array<DeviceExcludingDescriptionSerialNoDataLoggerIdDeviceTypeId>;
}

export interface DeviceControllerUpdateByIdRequest {
    id: number;
...
export class DeviceControllerApi extends BaseAPI {
     ...
     */
    deviceControllerDisableChannelMonitoring = ({ deviceId, channelId, all }: DeviceControllerDisableChannelMonitoringRequest): Observable<void> => {
        ...
        throwIfNullOrUndefined(all, 'deviceControllerDisableChannelMonitoring');
        ...
        return this.request<void>({
            path: '/device/{deviceId}/channel/{channelId}/disable-monitoring/all/{all}'.replace('{deviceId}', encodeURI(deviceId)).replace('{channelId}', encodeURI(channelId)).replace('{all}', encodeURI(all)),
            method: 'GET',
            headers,
        });
    };
     ...
     */
    deviceControllerEnableChannelMonitoring = ({ deviceId, channelId, all }: DeviceControllerEnableChannelMonitoringRequest): Observable<void> => {
        ...
        throwIfNullOrUndefined(all, 'deviceControllerEnableChannelMonitoring');
        ...
        return this.request<void>({
            path: '/device/{deviceId}/channel/{channelId}/enable-monitoring/all/{all}'.replace('{deviceId}', encodeURI(deviceId)).replace('{channelId}', encodeURI(channelId)).replace('{all}', encodeURI(all)),
            method: 'GET',
            headers,
        });
    };
     ...
     */
    deviceControllerFindChannelTypes = ({ deviceId }: DeviceControllerFindChannelTypesRequest): Observable<Array<ChannelType>> => {
     ...
     */
    deviceControllerGetDevicesWithType = ({ deviceExcludingDescriptionSerialNoDataLoggerIdDeviceTypeId }: DeviceControllerGetDevicesWithTypeRequest): Observable<Array<DeviceWithType>> => {
        ...
        return this.request<Array<DeviceWithType>>({
            path: '/devices/with-device-type',
            method: 'POST',
            headers,
            body: deviceExcludingDescriptionSerialNoDataLoggerIdDeviceTypeId,
        });
    };

    /**
     */
    deviceControllerUpdateById = ({ id, deviceExcludingIdSerialNoDataLoggerIdDeviceTypeId }: DeviceControllerUpdateByIdRequest): Observable<void> => {
        throwIfNullOrUndefined(id, 'deviceControllerUpdateById');
        ...
        return this.request<void>({
            path: '/device/{id}'.replace('{id}', encodeURI(id)),
            method: 'PATCH',
            headers,
            body: deviceExcludingIdSerialNoDataLoggerIdDeviceTypeId,
        });
    };
