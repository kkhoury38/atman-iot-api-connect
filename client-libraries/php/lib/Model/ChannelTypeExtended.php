...
/**
 * ChannelTypeExtended Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ChannelTypeExtended implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelTypeExtended';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['device_type_id'] === null) {
            $invalidProperties[] = "'device_type_id' can't be null";
        }
     ...
     * Sets device_type_id
     *
     * @param float $device_type_id ID of DeviceType that ChannelType belongs to
     *
     * @return $this
     */
     ...
     * Sets error
     *
     * @param bool $error Error status of channel type
     *
     * @return $this
     */
