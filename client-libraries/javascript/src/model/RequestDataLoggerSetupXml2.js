...
/**
 * The RequestDataLoggerSetupXml2 model module.
 * @module model/RequestDataLoggerSetupXml2
 * @version 3.0.1
 */
class RequestDataLoggerSetupXml2 {
    /**
     * Constructs a new <code>RequestDataLoggerSetupXml2</code>.
     * @alias module:model/RequestDataLoggerSetupXml2
     ...
     */
    constructor(objectListKey, model, serialNo, channelName, channelUnit, value, period, timestamp, confirm, fileFormat) { 
        
        RequestDataLoggerSetupXml2.initialize(this, objectListKey, model, serialNo, channelName, channelUnit, value, period, timestamp, confirm, fileFormat);
    }
     ...
     */
    static initialize(obj, objectListKey, model, serialNo, channelName, channelUnit, value, period, timestamp, confirm, fileFormat) { 
    ...
    /**
     * Constructs a <code>RequestDataLoggerSetupXml2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RequestDataLoggerSetupXml2} obj Optional instance to populate.
     * @return {module:model/RequestDataLoggerSetupXml2} The populated <code>RequestDataLoggerSetupXml2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RequestDataLoggerSetupXml2();
...
export default RequestDataLoggerSetupXml2;
