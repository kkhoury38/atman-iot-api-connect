...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.DeviceWithType();
  });
  ...
  describe('DeviceWithType', function() {
    it('should create an instance of DeviceWithType', function() {
      // uncomment below and update the code to test DeviceWithType
      //var instane = new AtmanIoT.DeviceWithType();
      //expect(instance).to.be.a(AtmanIoT.DeviceWithType);
    });
