...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.EventRuleWithRelations();
  });
  ...
  describe('EventRuleWithRelations', function() {
    it('should create an instance of EventRuleWithRelations', function() {
      // uncomment below and update the code to test EventRuleWithRelations
      //var instane = new AtmanIoT.EventRuleWithRelations();
      //expect(instance).to.be.a(AtmanIoT.EventRuleWithRelations);
    });
