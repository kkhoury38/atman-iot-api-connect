...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.UserSubscription();
  });
  ...
  describe('UserSubscription', function() {
    it('should create an instance of UserSubscription', function() {
      // uncomment below and update the code to test UserSubscription
      //var instane = new AtmanIoT.UserSubscription();
      //expect(instance).to.be.a(AtmanIoT.UserSubscription);
    });
