...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.DeviceTypeWithRelations();
  });
  ...
  describe('DeviceTypeWithRelations', function() {
    it('should create an instance of DeviceTypeWithRelations', function() {
      // uncomment below and update the code to test DeviceTypeWithRelations
      //var instane = new AtmanIoT.DeviceTypeWithRelations();
      //expect(instance).to.be.a(AtmanIoT.DeviceTypeWithRelations);
    });
