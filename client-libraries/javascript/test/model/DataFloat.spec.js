...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.DataFloat();
  });
  ...
  describe('DataFloat', function() {
    it('should create an instance of DataFloat', function() {
      // uncomment below and update the code to test DataFloat
      //var instane = new AtmanIoT.DataFloat();
      //expect(instance).to.be.a(AtmanIoT.DataFloat);
    });
