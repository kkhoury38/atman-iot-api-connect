...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.DeviceGroupMembership();
  });
  ...
  describe('DeviceGroupMembership', function() {
    it('should create an instance of DeviceGroupMembership', function() {
      // uncomment below and update the code to test DeviceGroupMembership
      //var instane = new AtmanIoT.DeviceGroupMembership();
      //expect(instance).to.be.a(AtmanIoT.DeviceGroupMembership);
    });
