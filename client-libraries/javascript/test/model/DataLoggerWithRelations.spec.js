...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.DataLoggerWithRelations();
  });
  ...
  describe('DataLoggerWithRelations', function() {
    it('should create an instance of DataLoggerWithRelations', function() {
      // uncomment below and update the code to test DataLoggerWithRelations
      //var instane = new AtmanIoT.DataLoggerWithRelations();
      //expect(instance).to.be.a(AtmanIoT.DataLoggerWithRelations);
    });
