...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.ChannelTypeExtended();
  });
  ...
  describe('ChannelTypeExtended', function() {
    it('should create an instance of ChannelTypeExtended', function() {
      // uncomment below and update the code to test ChannelTypeExtended
      //var instane = new AtmanIoT.ChannelTypeExtended();
      //expect(instance).to.be.a(AtmanIoT.ChannelTypeExtended);
    });
