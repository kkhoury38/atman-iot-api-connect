...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.DataText();
  });
  ...
  describe('DataText', function() {
    it('should create an instance of DataText', function() {
      // uncomment below and update the code to test DataText
      //var instane = new AtmanIoT.DataText();
      //expect(instance).to.be.a(AtmanIoT.DataText);
    });
