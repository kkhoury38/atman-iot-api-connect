...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AtmanIoT.ChannelTypeWithRelations();
  });
  ...
  describe('ChannelTypeWithRelations', function() {
    it('should create an instance of ChannelTypeWithRelations', function() {
      // uncomment below and update the code to test ChannelTypeWithRelations
      //var instane = new AtmanIoT.ChannelTypeWithRelations();
      //expect(instance).to.be.a(AtmanIoT.ChannelTypeWithRelations);
    });
